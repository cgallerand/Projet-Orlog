...
>>>>>>> develop
			...
			String SortSpecial = saisieString("Voulez vous utiliser une attaque spï¿½ciale ? (y/n)");
...
>>>>>>> develop
	...
	public static void LancerdeUser1() {
		...
		do {
			...
			System.out.println("\t === choix des dï¿½ ===");

			System.out.println("\t === Lancer1 - choix des dï¿½s ===");
